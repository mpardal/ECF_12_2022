 ...
 */
final class Version20220824073213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure CHANGE franchise_id_id franchise_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure CHANGE franchise_id franchise_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE structure ADD CONSTRAINT FK_6F0137EAEA39FCC8 FOREIGN KEY (franchise_id_id) REFERENCES franchise (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
